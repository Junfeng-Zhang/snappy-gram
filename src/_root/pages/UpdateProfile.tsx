    ...
    <div className="flex flex-1">
      <div className="common-container">
        <div className="justify-start w-full max-w-5xl gap-3 flex-start">
          ...
          <h2 className="w-full text-left h3-bold md:h2-bold">修改信息</h2>
        </div>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleUpdate)} className="flex flex-col w-full max-w-5xl mt-4 gap-7">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="shad-form_label">用户名</FormLabel>
                  <FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="shad-form_label">个人介绍</FormLabel>
                  <FormControl>
            ...
            <div className="flex items-center justify-end gap-4">
              <Button type="button" className="shad-button_dark_4" onClick={() => navigate(-1)}> 取消</Button>
              <Button
                type="submit"
